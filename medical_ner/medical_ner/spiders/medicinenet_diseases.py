...
class MedicineNetDiseasesSpider(scrapy.Spider):
    name = "medicinenet-diseases"
    diseases = set([])

    def start_requests(self):
        urls = ['https://www.medicinenet.com/diseases_and_conditions/alpha_{}.htm'.format(chr(i)) for i in range(97, 123)]
        for url in urls:
    ...
    def parse(self, response):
        ...
        for listing in listings:
            for disease in self._process_brackets(listing):
